...
import com.c2p.h2.service.EmployeeService;
...
public class EmployeeController 
{
    ...
    public ResponseEntity<EmployeeEntity> createOrUpdateEmployee(@RequestBody EmployeeEntity employee)
    	...
    	System.out.println("FName:"+employee.getFirstName());
    	System.out.println("Lname:"+employee.getLastName());
